...
public class AttrServiceImpl implements AttrService {
    ...
    @Override
    public List<PmsBaseAttrInfo> getPmsBaseAttrInfoByValueId(Set<String> valueIdSet) {
        String valuedIds = StringUtils.join(valueIdSet, ",");

        List<PmsBaseAttrInfo> pmsBaseAttrInfos= pmsBaseAttrInfoMapper.selectPmsBaseAttrInfoByValueId(valuedIds);
        return pmsBaseAttrInfos;
    }
}
